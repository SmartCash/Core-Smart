...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000004dbf1dea993236b0e3");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000000000003fba5e0604a5b76d9975169d38521e3fbed206c2f05f3cbab062"); // 1795520
        ...
        // TermRewards Start
        consensus.nRewardsFirst_2_0_Round = 57; // Round 57 starts 1970600 was Round 52 on 11/21 starts on block 1915600 must match block set on consensus/params.h
        ...
        checkpointData = (CCheckpointData) {
            ...
            1600716503, // * UNIX timestamp of last checkpoint block
            13925767,  // * total number of transactions between genesis and last checkpoint
