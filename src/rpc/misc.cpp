...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given smartcash address.\n"
            "\nArguments:\n"
            "1. \"smartcashaddress\"     (string, required) The smartcash address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"smartcashaddress\", (string) The smartcash address validated\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "smartcash|privatesend|instantsend|smartnode|spork|keepass|mnpayments|gobject )\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are smartcash addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) smartcash address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"smartcashaddress\"  (string, required) The smartcash address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", \"signature\", \"my message\"")
        );
