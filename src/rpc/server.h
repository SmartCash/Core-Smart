...
extern UniValue getdummybalance(const UniValue& params, bool fHelp);
extern UniValue setdummybalance(const UniValue& params, bool fHelp);
...
extern UniValue getaddresses(const UniValue& params, bool fHelp);
