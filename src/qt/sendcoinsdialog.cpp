...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    if (nLockTime > 0) {
        ...
        questionString.append(tr("TermRewards requires 1,2, or 3 year TimeLock and 101K Smart"));
        questionString.append(tr("SmartRetire requires a 15 year TimeLock and 101K Smart"));
...
void SendCoinsDialog::processSendCoinsReturn(const WalletModel::SendCoinsReturn &sendCoinsReturn, const QString &msgArg)
{
    ...
    case WalletModel::PaymentRequestExpired:
        ...
        msgParams.second = CClientUIInterface::MSG_ERROR;
        break;
    case WalletModel::AmountSmallerThanFees:
        msgParams.first = tr("The amount to pay is smaller than the minimum transaction fee.");
        msgParams.second = CClientUIInterface::MSG_ERROR;
        break;
