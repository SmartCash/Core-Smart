...
{
public:
    explicit SendCoinsRecipient() : amount(0), nLockTime(0), fSubtractFeeFromAmount(false), nVersion(SendCoinsRecipient::CURRENT_VERSION) { }
...
public:
    ...
    CAmount getBalance(const CCoinControl *coinControl = NULL, bool countTimeLocked = true) const;
    ...
    bool isMine(const CTxDestination &address) const;
