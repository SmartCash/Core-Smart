...
public:
    ...
    CSmartRewardBlock(int height, uint256 &hash, int64_t t) : nHeight(height), blockHash(hash), blockTime(t) {}
...
public:
    ...
    bool SyncBlocks(const CSmartRewardBlockList &blocks, const CSmartRewardEntryList &update, const CSmartRewardEntryList &remove);
