...
static const CAmount HIGH_TX_FEE_PER_KB = .01 * CENT;
...
static const int64_t nStartRewardTime = 1499789471; // 07/11/2017 @ 11:11am (CST)
...
bool CheckTransaction(const CTransaction& tx, CValidationState& state, uint256 hashTx, bool isVerifyDB, int nHeight = INT_MAX, int64_t txTime = INT_MAX);
