...
static const int REWARDS_VOTEPROOF_O1_SCRIPT_SIZE = 0x5E;
static const int REWARDS_VOTEPROOF_O1_DATA_SIZE = 0x5B;

static const int REWARDS_VOTEPROOF_O2_SCRIPT_SIZE = 0xB7;
static const int REWARDS_VOTEPROOF_O2_DATA_SIZE = 0xB4;
