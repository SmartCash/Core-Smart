...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleRpc("setaccount", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", \"tabby\"")
        );
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\"")
            + HelpExampleRpc("getaccount", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\"")
        );
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 6)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "                             transaction, just kept in your wallet.\n"
            "5. subtractfeefromamount  (boolean, optional, default=false) The fee will be deducted from the amount being sent.\n"
            "                             The recipient will receive less amount of SmartCash than you enter in the amount field.\n"
            "\nResult:\n"
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", 0.1, \"donation\", \"seans outpost\"")
        );
    LOCK2(cs_main, pwalletMain->cs_wallet);
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", 6")
       );
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            ...
            "                           Those recipients will receive less smartcash than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\":0.01,\\\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\":0.01,\\\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\":0.01,\\\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\\\":0.02}\" 1 \"\" \"[\\\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XZ\\\",\\\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\":0.01,\\\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\\\":0.02}\", 6, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid SmartCash address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a SmartCash address or hex-encoded public key.\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"171sgjn4YtPu27adkKGrdDwzRTxnRkBfKV\\\"]\"")
        ;
...
UniValue listreceivedbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. minconf      (numeric, optional, default=1) The minimum number of confirmations before payments are included.\n"
            "2. addlockconf      (bool, optional, default=false) Whether to add " + std::to_string(nInstantSendDepth) + " confirmations to transactions locked via InstantPay.\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 2))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending smartcash\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending smartcash\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"smartcashaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "wallet encrypted; SmartCash server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending smartcash.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"SXun9XDHLdBhG4Yd1ueZfLfRpC9kZgwT1b\\\",\\\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid SmartCash address: ")+input.get_str());
            if (setAddress.count(address))
