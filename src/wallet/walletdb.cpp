...
public:
    ...
    unsigned int nMapVoted;
    unsigned int nMapVoteProofs;
    bool fIsEncrypted;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "tx")
        {
            ...
            if (!(CheckTransaction(wtx, state, wtx.GetHash(), true) && (wtx.GetHash() == hash) && state.IsValid()))
                return false;
