...
QMAKE_CXXFLAGS += -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -std=c++11 -DBOOST_NO_CXX11_SCOPED_ENUMS -DMINIUPNP_STATICLIB
...
macx:ICON = src/qt/res/icons/smartcash.icns
